...
export function checkFow(currentLinkFow: formOfWay, LRPFow: number){
    ...
    case 2: return OS_OPEN_ROADS ? currentLinkFow === formOfWay.DualCarriageway || currentLinkFow === formOfWay.Motorway || formOfWay.SingleCarriageway : currentLinkFow === formOfWay.DualCarriageway || currentLinkFow === formOfWay.Motorway;
